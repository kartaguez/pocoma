...
@ConfigurationProperties("pocoma.latest-known-version-consumption")
public class LatestKnownVersionConsumptionProperties {
	private boolean enabled;
	private int segmentIndex;
	private int segmentCount = 1;
	private String workerId = "latest-known-version-consumption-worker";
