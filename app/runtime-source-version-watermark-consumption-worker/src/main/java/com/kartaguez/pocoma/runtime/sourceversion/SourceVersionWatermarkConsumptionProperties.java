...
@ConfigurationProperties("pocoma.source-version-watermark-consumption")
public class SourceVersionWatermarkConsumptionProperties {
	private boolean enabled;
	private int segmentIndex;
	private int segmentCount = 1;
	private String workerId = "source-version-watermark-consumption-worker";
