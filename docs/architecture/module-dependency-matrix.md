...
| `engine-processing-command` | ancien contrat de sélection et lifecycle Command | command legacy, consumption, core | Event/Task processing, frameworks, execution guard | legacy — retrait après cutover Command |
